...
INICIO		CALL		limpia_registros
			...
			;no deseamos					;		•	Poner a ‘1’ bit ADIE
											;		•	Poner a ‘1’ bit PEIE
											;		•	Poner a ‘1’ bit GIE
REG		CALL 		t_adq_20micros		;3.	Esperar el tiempo de adquisición requerido
...
ESP		BTFSC		ADCON0,2			;5.	Esperar para completar la conversión A/D, por cualquiera de los siguientes:
			...
			MOVF		ADRESL,0			;mueve el registro ADRESL al registro W
...
;##########################################################################################################################
;-----------------------------------------------------------------------------------------------------------------------------------------------------------------
configura_oscilador			BSF		STATUS,RP0					; selecciona Banco 1; Se encuentran registros TRISA y TRISB
							...
							RETURN
;###################################################################################################################################
configura_comparadores		MOVLW		B'00000100'							;carga el registro W con 07		0000 0111
...
configura_puertos				BSF		STATUS,RP0					; cambio a banco 1
...
configura_convertidor			BSF		STATUS,RP0		; selecciona banco 1
...
configura_interrupciones	BSF		STATUS,RP0					; selecciona banco 1
...
configura_TMR0			BSF		STATUS,RP0					; 
						...
						RETURN
;#####################################################################################################################
retraso_50msTMR0		BSF		STATUS,RP1	;
						BCF		STATUS,RP0	;cambia a banco 2
...
;#######################################################################################################################
t_adq_20micros			MOVLW		H'06'			; (1) ciclo de instruccion
						MOVWF		T_ADQ			; (1)
esp_t_adq				DECFSZ	T_ADQ,1		; (1)
						GOTO		esp_t_adq		; (2)					
