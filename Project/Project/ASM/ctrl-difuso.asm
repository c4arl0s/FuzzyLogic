...
LEE_MODO			BTFSS		MODO_OPERACION,0		; LEE MODO DE OPERACION
					...
					GOTO		LEE_TEMP
LEE_TEMP			CALL		LEER_TEMP_ACTUAL		; MODO EN REPOSO (DESPLIEGA TEMP ACTUAL)
					CALL		DESPLEGAR_TEMP_ACTUAL; MODO EN REPOSO (DESPLIEGA TEMP ACTUAL)
...
ACCIONA_CONTROL	CALL		LEE_TEMP_ACTUAL			; MODO ACCION DE CONTROL (CONTROLA LA TEMP)
					...
					CALL		ERROR_DE_TEMP2			; debe ser inicializado con algun valor
					...
					;=====================================================================================================							
					MOVLW		H'78'							; si lo hace 120 veces, entonces ha transcurrido 1 [s] ---> 83.33 [micro s] x 120 = 1 [s]
...
DESPLEGAR_TEMP_ACTUAL	NOP
								...
								RETURN								
;###################################################################################################################
ERROR_DE_TEMP1				MOVF		TEMP_ACTUAL1,0		;MUEVE EL DATO DE TEMPERATURA ACTUAL AL REGISTRO W
