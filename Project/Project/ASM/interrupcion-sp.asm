...
INICIA_SP		MOVLW		H'09'
				...
				;----------------------------------------------------------------------------------------------				
REV_BOTON	MOVF		PORTA,0
DECISION 		ADDWF 	PCL,1		
				GOTO 		ACCION0
				GOTO 		ACCION_1U
				GOTO 		ACCION_2D
				GOTO		ACCION_3out
...
ACCION0		
				GOTO 		REV_BOTON
				;-------------------------------------------------------------------
ACCION_1U		DECFSZ	UNI
				GOTO		AC_1U
				CALL		desplegar_u_bcd
				GOTO		INICIA_SP				
AC_1U			CALL		desplegar_u_bcd								
				GOTO 		REV_BOTON
				;-------------------------------------------------------------------
ACCION_2D		DECFSZ	DECE
				GOTO		AC_1U
				CALL		desplegar_d_bcd
				GOTO		INICIA_SP				
AC_1D			CALL		desplegar_d_bcd								
				GOTO 		REV_BOTON
				;-------------------------------------------------------------------				
ACCION_3out
				GOTO 		SIGUEPROG
...
desplegar_u_bcd		BANCO0
					MOVF		UNI,0		; mueve el reg BCDL al registro W
					MOVWF		PORTB		; mueve el registro W al PORTB
					BTFSS		UNI,0		; salta si hay un '1' en el bit0 del registro BCDL
...
desplegar_d_bcd		BANCO0
					MOVF		DECE,0		; mueve el reg BCDL al registro W
					MOVWF		PORTB		; mueve el registro W al PORTB
					BTFSS		DECE,0		; salta si hay un '1' en el bit0 del registro BCDL
